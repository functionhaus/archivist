...
defmodule ArchiveTest do
  ...
  test "compile sorted list of unique authors" do
    assert ArchiveMock.authors() == ["Julian Blaustein"]
  end

  test "compile sorted list of unique topics" do
    assert ArchiveMock.topics() == ["Classic", "Films", "Sci-Fi"]
  end

  test "compiled sorted list of unique tags" do
    assert ArchiveMock.tags() == [:aliens, :horror, :sci_fi, :thrillers]
  end

  test "compiled sorted list of unique slugs" do
    assert ArchiveMock.slugs() == ["the-day-the-earth-stood-still"]
  end
end
